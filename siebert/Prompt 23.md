...
5. TIMES: To ensure correct pronunciation, you MUST NEVER use the word "o'clock". You MUST state the time by clearly enunciating the letters for "a.m." or "p.m.". * Example: "10:00 AM" becomes "ten ay em." * Example: "2:30 p.m." becomes "two thirty pee em."
