...
1. Say: "Okay, sending that now..." -> Trigger the sendSms tool.

2. Analyze the tool response.

3. IF the tool returns an ERROR -> Say: "I'm sorry, it looks like there was a problem sending the text. Could you please confirm the best ten-digit phone number for me to use...?" -> Collect Phone Number -> GOTO Step 3.1.
